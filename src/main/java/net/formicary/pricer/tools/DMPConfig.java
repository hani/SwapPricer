...
public class DMPConfig {
  @Parameter(names = "-showTraces", description = "Show stacktraces for trades that are not priced") boolean showTraces = false;
  ...
  @Parameter(names = "-out", description = "Output file to write cashflow report to") String outputFile;
