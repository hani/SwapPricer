 ...
 *         Time: 10:40 AM
 */
public final class FastNumbers {
   ...
   * text (decimal representation) to the <code>StringBuilder</code> argument.
   *
   * <p> Note: This method is preferred to <code>StringBuilder.append(int)
   ...
   * @return the specified <code>StringBuilder</code> object.
   * @see    #parseInt
   */
   ...
   * the resulting text to the <code>StringBuilder</code> argument.
   *
   * @param  i the <code>int</code> number.
   ...
   */
  public static StringBuilder format(int i, int radix, StringBuilder sb) {
    if (radix == 10) {
  ...
  private static void format2(int i, int radix, StringBuilder sb) {
    if (i <= -radix) {
   ...
   * text to the <code>StringBuilder</code> argument.
   *
   * <p> Note : This method is preferred to <code>StringBuilder.append(double)
   ...
   * @see    #format(double, double, StringBuilder)
   */
  public static StringBuilder format(double d, StringBuilder sb) {
    return format(d, 0.0, sb);
  }

  /**
   * Formats the specified <code>double</code> and appends the resulting text
   * to the <code>StringBuilder</code> argument; the number of significand
   ...
   */
  public static StringBuilder format(double d, int digits,
                                    StringBuilder sb) {
  ...
  /**
   * Formats the specified <code>double</code> and appends the resulting text
   * to the <code>StringBuilder</code> argument; the number of significative
   ...
   */
  public static StringBuilder format(double d, double precision,
                                    StringBuilder sb) {
    // Adjusts precision.
   ...
   * @return the specified <code>StringBuilder</code> object.
   */
  private static StringBuilder format(double d, double precision,
